...
export interface Dom {
  (): DomArray;
  (selector: string, context?: Element | DomArray): DomArray;
  (element: Element): DomArray;
  (element: Document): DomArray;
  (elementArray: Element[]): DomArray;
  (event: EventTarget): DomArray;
  fn: any;
}
